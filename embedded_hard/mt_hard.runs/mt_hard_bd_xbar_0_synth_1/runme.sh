...
HD_PWD='D:/mt_hard/mt_hard.runs/mt_hard_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mt_hard_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mt_hard_bd_xbar_0.tcl
