...
HD_PWD='D:/mt_hard/mt_hard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mt_hard_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mt_hard_bd_wrapper.tcl -notrace
