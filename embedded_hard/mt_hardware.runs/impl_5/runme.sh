...
HD_PWD='D:/metastability-tool/embedded_hard/hard_v2/project_1.runs/impl_5'
cd "$HD_PWD"
...
EAStep vivado -log Proyecto_TADSE_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Proyecto_TADSE_wrapper.tcl -notrace
