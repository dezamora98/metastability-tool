...
HD_PWD='D:/metastability-tool/embedded_hard/Proyecto_TADSE_IP_Custom/Proyecto_TADSE/Proyecto_TADSE.runs/Proyecto_TADSE_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Proyecto_TADSE_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Proyecto_TADSE_clk_wiz_0_0.tcl
