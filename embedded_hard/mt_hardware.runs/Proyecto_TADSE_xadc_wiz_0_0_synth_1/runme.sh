...
HD_PWD='D:/metastability-tool/embedded_hard/hard_v2/project_1.runs/Proyecto_TADSE_xadc_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Proyecto_TADSE_xadc_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Proyecto_TADSE_xadc_wiz_0_0.tcl
