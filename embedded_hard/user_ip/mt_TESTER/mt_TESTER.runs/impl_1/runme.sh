...
HD_PWD='D:/mt_TESTER/mt_TESTER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Circuito_para_pruebas_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Circuito_para_pruebas_v1_0.tcl -notrace
