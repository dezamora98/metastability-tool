...
HD_PWD='D:/mt_TESTER/mt_TESTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Circuito_para_pruebas_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Circuito_para_pruebas_v1_0.tcl
