...
module Proyecto_TADSE_clk_wiz_0_0_mmcm_drp
   #(
      //***********************************************************************
  ...
  parameter   S1_Filter_1     = 16'h0000,
  parameter   S1_Filter_2     = 16'h0000
   ) (
  input [15:0]  S2_Power    , 
  ...
  input [15:0] S2_Filter_1  ,
  input [15:0] S2_Filter_2  ,
      input             LOAD,
   ...
   initial begin
      ...
      ram[0] = {7'h28, 16'h0000, S1_Power};
      
      // Store CLKOUT0 divide and phase
      ram[1]  = {7'h08, 16'h1000, S1_CLKOUT0_1};
      ram[2]  = {7'h09, 16'h8000, S1_CLKOUT0_2};

      // Store CLKOUT1 divide and phase
      ram[3]  = {7'h0A, 16'h1000, S1_CLKOUT1_1};
      ram[4]  = {7'h0B, 16'hFC00, S1_CLKOUT1_2};
      
      // Store CLKOUT2 divide and phase
      ram[5]  = {7'h0C, 16'h1000, S1_CLKOUT2_1};
      ram[6]  = {7'h0D, 16'hFC00, S1_CLKOUT2_2};
      
      // Store CLKOUT3 divide and phase
      ram[7]  = {7'h0E, 16'h1000, S1_CLKOUT3_1};
      ram[8]  = {7'h0F, 16'hFC00, S1_CLKOUT3_2};
      
      // Store CLKOUT4 divide and phase
      ram[9]  = {7'h10, 16'h1000, S1_CLKOUT4_1};
      ram[10]  = {7'h11, 16'hFC00, S1_CLKOUT4_2};
      
      // Store CLKOUT5 divide and phase
      ram[11] = {7'h06, 16'h1000, S1_CLKOUT5_1};
      ram[12] = {7'h07, 16'hC000, S1_CLKOUT5_2};
      
      // Store CLKOUT6 divide and phase
      ram[13] = {7'h12, 16'h1000, S1_CLKOUT6_1};
      ram[14] = {7'h13, 16'hC000, S1_CLKOUT6_2};
      
      // Store the input divider
      ram[15] = {7'h16, 16'hC000, S1_DIVCLK};
      
      // Store the feedback divide and phase
      ram[16] = {7'h14, 16'h1000, S1_CLKFBOUT_1};
      ram[17] = {7'h15, 16'h8000, S1_CLKFBOUT_2};
    
      // Store the lock settings
      ram[18] = {7'h18, 16'hFC00, S1_Lock_1 };
      ram[19] = {7'h19, 16'h8000, S1_Lock_2};
      ram[20] = {7'h1A, 16'h8000, S1_Lock_3};
      
      // Store the filter settings
      ram[21] = {7'h4E, 16'h66FF, S1_Filter_1};
      ram[22] = {7'h4F, 16'h666F, S1_Filter_2};
   ...
   if (LOAD) begin 
      // Store the power bits
      ram[23] <= {7'h28, 16'h0000, S2_Power};
      
      // Store CLKOUT0 divide and phase
      ram[24] <= {7'h08, 16'h1000, S2_CLKOUT0_1};
      ram[25] <= {7'h09, 16'h8000, S2_CLKOUT0_2};
      
      // Store CLKOUT1 divide and phase
      ram[26] <= {7'h0A, 16'h1000, S2_CLKOUT1_1};
      ram[27] <= {7'h0B, 16'hFC00, S2_CLKOUT1_2};
     
      // Store CLKOUT2 divide and phase
      ram[28] <= {7'h0C, 16'h1000, S2_CLKOUT2_1};
      ram[29] <= {7'h0D, 16'hFC00, S2_CLKOUT2_2};
      
      // Store CLKOUT3 divide and phase
      ram[30] <= {7'h0E, 16'h1000, S2_CLKOUT3_1};
      ram[31] <= {7'h0F, 16'hFC00, S2_CLKOUT3_2};
      
      // Store CLKOUT4 divide and phase
      ram[32] <= {7'h10, 16'h1000, S2_CLKOUT4_1};
      ram[33] <= {7'h11, 16'hFC00, S2_CLKOUT4_2};
      
      // Store CLKOUT5 divide and phase
      ram[34] <= {7'h06, 16'h1000, S2_CLKOUT5_1};
      ram[35] <= {7'h07, 16'hC000, S2_CLKOUT5_2};
      
      // Store CLKOUT6 divide and phase
      ram[36] <= {7'h12, 16'h1000, S2_CLKOUT6_1};
      ram[37] <= {7'h13, 16'hC000, S2_CLKOUT6_2};
      
      // Store the input divider
      ram[38] <= {7'h16, 16'hC000, S2_DIVCLK};
      
      // Store the feedback divide and phase
      ram[39] <= {7'h14, 16'h1000, S2_CLKFBOUT_1};
      ram[40] <= {7'h15, 16'h8000, S2_CLKFBOUT_2};
      
      // Store the lock settings
      ram[41] <= {7'h18, 16'hFC00, S2_Lock_1};
      ram[42] <= {7'h19, 16'h8000, S2_Lock_2};
      ram[43] <= {7'h1A, 16'h8000, S2_Lock_3};
      
      // Store the filter settings
      ram[44] <= {7'h4E, 16'h66FF, S2_Filter_1};
      ram[45] <= {7'h4F, 16'h666F, S2_Filter_2};
     end
   end
