...
################################################################
# This is a generated script based on design: Proyecto_TADSE
#
...
# source Proyecto_TADSE_script.tcl
...
set design_name Proyecto_TADSE
...
CONFIG.PHASE {0.000} \
  ...
  # Create instance: Circuito_para_pruebas_0, and set properties
  set Circuito_para_pruebas_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Circuito_para_pruebas:1.0 Circuito_para_pruebas_0 ]
...
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#gpio[28]#gpio[29]#gpio[30]#gpio[31]#gpio[32]#gpio[33]#gpio[34]#gpio[35]#gpio[36]#gpio[37]#gpio[38]#gpio[39]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#cd#tx#rx#gpio[50]#gpio[51]#gpio[52]#gpio[53]} \
...
CONFIG.VCCDDRO_ALARM_LOWER.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Circuito_para_pruebas_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Circuito_para_pruebas_0/clk_generador_dato] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins Circuito_para_pruebas_0/clk_circuito_test] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Circuito_para_pruebas_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins Circuito_para_pruebas_0/s00_axi_aresetn] [get_bd_pins clk_wiz_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Circuito_para_pruebas_0/S00_AXI/S00_AXI_reg] SEG_Circuito_para_pruebas_0_S00_AXI_reg
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 1:140 -defaultsOSRD -top
preplace port sys_clock -pg 1 -y 480 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 1:160 -defaultsOSRD -top
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -y 590 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 3 -y 650 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 320 -defaultsOSRD
preplace inst Circuito_para_pruebas_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 3 -y 430 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 280 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 1 410
...
preplace netloc sys_clock_1 1 0 3 NJ 480 NJ 480 850J
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 820
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 2 440 160 800
preplace netloc processing_system7_0_FIXED_IO 1 1 1 420
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 440 680 840
preplace netloc clk_wiz_0_clk_out1 1 2 2 840 120 1150
preplace netloc clk_wiz_0_clk_out2 1 2 2 850 130 1140
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 130 430 130 830
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 810
levelinfo -pg 1 0 220 640 1010 1260 1370 -top -20 -bot 810
",
}
